...
namespace Fitmeplan.ServiceBus.Core
{
    ...
    {
        private readonly ExceptionInformation _exceptionDetails;

        public ExceptionInformation ExceptionDetails => _exceptionDetails;
        ...
        public ServiceBusException(ExceptionInformation exceptionDetails) : this(exceptionDetails.Message)
        {
